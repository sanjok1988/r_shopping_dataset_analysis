...
hist(x$payment_method, freq = FALSE, main = "Histogram and Density Plot of Payment Method", xlab = "Payment Method", ylab = "Density", 
     breaks = length(unique(x$payment_method)), axes = FALSE)
...
plot(x$payment_method,Y,main = "Correlation between payment and quantity signal",xlab = "payment_method",ylab = "quantity")
